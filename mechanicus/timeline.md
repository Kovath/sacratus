# Sacratan Mechanicus Timeline

> **Canon note:** This timeline focuses on the Mechanicus of Sacratus rather than repeating the full setting chronology. For system-wide context, see [`../timeline.md`](../timeline.md). Unmarked entries are established canon; unresolved material is explicitly marked **PROVISIONAL**, **OPEN**, or **UNKNOWN IN-UNIVERSE**.
...
The exact early industrial geography, founding mechanism of the Forge World, relationship to Mars, and Heresy-era internal Mechanicum politics remain **OPEN** unless established elsewhere.

## Post-Heresy / pre-Breaking

The local priesthood continues as part of the Adeptus Mechanicus.

The Mechanicus becomes one of the principal jurisdictions that eventually participate in the **Consistorium** and **Concordat of Sacratus**.

Sacratan industry remains deeply connected to Imperial networks beyond the system and is not designed as a perfectly self-contained economy.

## 100.M40 — The Breaking

The Warp phenomenon isolates Sacratus and mass Chaos assault begins.

External supply, replacement expertise, and routine contact with the wider Mechanicus disappear.
...
The Mechanicus participates in the Reformation's development of horizontal Sacratan dependencies.

Industrial practice increasingly emphasizes:
...
The Forge World remains a distinct jurisdiction rather than becoming subordinate to the Palatinae.

## ~250.M40 onward — High Vigil

Sacratan industry recovers sufficiently to create real maintenance and investment margin.
...
Under Basilios, the Mechanicus participates in preventing Ravenna's consequences from cascading into wider system collapse.

High-Vigil industrial assumptions remain in place longer than the resources required to sustain them.

## 761.M40–096.M41 — Grand Calculus and Contraction

Leontios forces a system-wide accounting of what can genuinely be sustained.

The Mechanicus process becomes the:

> **Grand Calculus of Necessary Diminution, Translation, and Continuance of the Sacred Manufactoria of Sacratus**

The Calculus contracts, consolidates, salvages, and translates industrial capacity into a smaller sustainable core.

Approximate aggregate scale — **PROVISIONAL exact figures**:
...
## 096.M41 onward — Post-Leontian recoil

The Mechanicus becomes more protective of internal information, reserves, and jurisdiction.

Compartmentalization increases during the **Long Tension**. Cooperation continues, but disclosure is no longer assumed to be safe merely because another Sacratan institution requests it.

Mechanicus sovereignty becomes one of the major unresolved Concordat fault lines.

## 386–711.M41 — Long Siege

Under Manuel, surviving industrial capacity operates under effectively continuous strategic pressure.

Maintenance, salvage, repair cycles, replacement, and expertise preservation become increasingly important as redundancy disappears.

The exact Mechanicus role in individual Space Hulk operations remains **OPEN**.

## Quiet Vigil

The Silence reduces organized external strategic pressure without ending local Warp danger.

For the Mechanicus, the principal gain is time: deeper maintenance, deferred repairs, training, and knowledge transfer become easier to sustain.

The Forge World recovers cautiously rather than returning to High-Vigil abundance.

## 999.M41 — Final Hell

The surrounding Warp phenomenon catastrophically destabilizes.

The detailed industrial losses and emergency Mechanicus actions during the Final Hell remain **OPEN**.

## 999.M41 onward — Reintegration

The storm dissipates and contact with Mars and the wider Adeptus Mechanicus returns.

Sacratan Mechanicus continuity enters a period of **verification and contest**: records, technical lineages, practices, authority, and almost nineteen centuries of isolated adaptation can once again be examined by outside Mechanicus institutions.

The local priesthood regards itself as continuously loyal. The detailed Martian response and final settlement remain **OPEN**.
