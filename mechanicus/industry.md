...
The characteristic Long-Vigil problem is **continuity under load**.

Industrial systems are repeatedly asked to produce at wartime intensity while also preserving the machines, people, knowledge, and support infrastructure required to continue producing in the future.
...
Reclamation becomes normal industrial practice under isolation.

Components, machinery, materials, and useful subassemblies are recovered from damaged or abandoned systems whenever their continued use elsewhere is worth more than preserving the original installation intact.

**Translation** is especially important during the Contraction: capability is not always preserved by keeping a facility where it was. Machines, personnel, archives, and support systems can be moved or redistributed so that their service continues in a smaller industrial geography.

This creates the recurring tension summarized as **form versus service**.

A sacred installation may possess history, identity, and ritual continuity that are genuinely meaningful. Dismantling it is therefore not treated as spiritually neutral merely because some of its parts continue working elsewhere.

At the same time, refusing all translation can result in the loss of both the original form and the service it provided.

The setting does not currently establish neat formal factions around this tension.

## High Vigil abundance

The High Vigil demonstrates how different Mechanicus behavior becomes when the system possesses margin.

Stable food, population recovery, and reduced strategic pressure allow:

- preventative rather than purely emergency maintenance;
- longer repair cycles;
- training and replacement of specialists;
- expansion of selected industrial chains;
- investment whose value may not be realized immediately;
- greater redundancy.
...
By the Low Vigil, headline industrial capacity becomes increasingly misleading.

A manufactorium can remain on official rolls while requiring disproportionate transport, repairs, specialist labor, power, or scarce components merely to continue producing at a fraction of its former reliability.

The relevant question becomes:

> **What service can this system continue to provide without consuming the capacity required to preserve everything else?**

The Grand Calculus is the largest institutional attempt to answer that question.

## Grand Calculus

The **Grand Calculus of Necessary Diminution, Translation, and Continuance of the Sacred Manufactoria of Sacratus** occurs during Leontios's Contraction.
...
- reduce maintenance and logistical burdens faster than useful output is lost.

The established aggregate outcome is severe but not intended as exact final arithmetic:

- roughly **60% of the maintained industrial footprint** is lost, abandoned, dismantled, or translated;
- nominal capacity approaches roughly **one third** of its former level;
- **PROVISIONAL exact figures**;
- useful sustainable output declines less sharply than nominal capacity because the process deliberately stops spending resources on capacity that can no longer be honestly supported.

The Calculus is therefore simultaneously destruction and preservation.

That duality is the source of much of its Mechanicus trauma.

## Production after the Calculus

The post-Calculus Mechanicus is materially smaller but less burdened by industrial obligations it cannot fulfill.

The remaining network is more concentrated and therefore potentially more efficient, but also more brittle: consolidation reduces some waste while removing redundancy.

Later losses can therefore be disproportionately serious because fewer alternative lines, facilities, specialists, and transport paths remain.

During the Long Siege, preserving repair cycles and expertise can matter as much as maximizing immediate production.

## Quiet Vigil maintenance

The Silence improves industrial conditions without creating abundance.

The most important change is that urgent wartime demand no longer interrupts every maintenance cycle.

Deferred repairs can be completed. Equipment can remain dismantled long enough for proper restoration. Specialists can train successors. Records can be reviewed and reconciled rather than merely used in crisis.

The Mechanicus becomes somewhat less brittle before Reintegration, but it does not recreate the industrial depth of the High Vigil.
...
**OPEN:** The exact industrial recovery after Reintegration, outside investment, Martian demands, technology transfers, and disputes over local practices remain to be developed.
