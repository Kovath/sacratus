# Sacratan Military — Overview

> **Canon note:** This file is the high-level canonical reference for the conventional human military forces of Sacratus. Unmarked statements are established canon. Material explicitly marked **OPEN** retains that status.

## Scope

The **Sacratan Military** is an umbrella term for the conventional human armed forces responsible for the bulk of system-scale defense.
...
The Sacratan Military bears most of the continuous, system-scale burden of the Long Vigil.

As the strategic margin worsens, its problem changes from defending an expanding network to maintaining an increasingly small set of load-bearing positions. Under Leontios, fleets, fortifications, Comitatenses deployments, Limitanei positions, and long-term defense plans are deliberately contracted as Sacratus abandons geography it can no longer sustain.

By the Long Siege, conventional forces remain the principal mass defenders while the Palatinae operate near a demographic floor.

## Reintegration

Reintegration reconnects Sacratus with wider Imperial military authorities after almost nineteen centuries of isolation.

The exact treatment of Long-Vigil military institutions, including the status of the Limitanei and Comitatenses within restored Imperial jurisdiction, remains **OPEN**.

## Still open

The following are not yet established in detail:
...
- equipment tables and vehicle holdings;
- the exact place of naval and void forces within the Limitanei/Comitatenses framework;
- named commanders and representative formations;
- post-Reintegration settlement with outside Imperial military authorities.